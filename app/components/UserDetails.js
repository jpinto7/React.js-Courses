...
const UserDetails = (user) =>
  <div>
    {(user.score >= 0) && <li className='list-group-item'><h3>Score: {user.score}</h3></li>}
    ...
    <li className='list-group-item'>Followers: {user.info.following}</li>
    <li className='list-group-item'>Following: {user.info.followers}</li>
